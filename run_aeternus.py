...
def main():
    print("=" * 80)
    print("  Project AETERNUS — GPU-Accelerated Hybrid Trading Optimizer")
    ...
    # ── Summary ──
    print("\n" + "=" * 80)
    print(f"  AETERNUS COMPLETE — Total time: {total_time:.1f}s")
    print("=" * 80)
    ...
    if results and "alpha" in results:
        ...
        print(f"\n  Results: ~/aeternus/results/aeternus_results.json")
        print(f"  Alpha:   ~/aeternus/results/aeternus_alpha.json")
