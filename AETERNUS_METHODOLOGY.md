...
Unlike traditional event-driven backtesters, AETERNUS utilizes a **fully vectorized simulation architecture** built on PyTorch.
...
AETERNUS categorizes the market into three distinct risk tiers, each with its own optimized search space:
...
AETERNUS employs a sophisticated **Adaptive Trailing Stop (ATS)** model that replaces static Take-Profit orders.
...
---
*Documented by AETERNUS Core Engine — March 29, 2026*
