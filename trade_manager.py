"""
Project AETERNUS — TradeManager (ULTRA-AGGRESSIVE).
"""
...
def simulate_batch(data: dict, params: torch.Tensor) -> BatchResult:
    ...
    # Aggressive Score: PnL / (Max Drawdown + 1) -> Here just PnL + WR
    score = net_pnl / 100.0 + win_rate * 50.0
    score = torch.where(n_trades >= 15, score, score - 5000.0)
